...
A list of known good settings is available on the sheet next to the computer.

The currently fitten lens (F=50.8mm) should be good for cutting material up to ~10mm.
If you want to try and cut something thicker, we do have other lenses.
Ask Dan if you have a reason to need this.
...
In front of the machine/around the corner, on the black table is a waste bin for scraps that are no longer wanted but still potentially useful along with some 6mm birth plywood that is available to use.
...
If any of the following happen, immediately stop using the machine, turn off both switched sockets on the wall behind/in between the machine and the cooler unit and let Dan know:

- illuminates all three status lamps at once
- leaks cooling water
- a collision involving a moving part of the machine
